...
public class MinimalPlayback : MonoBehaviour
{
    ...
    public void PlayPause()
    {
        ...
        else
        {
            ...
            if(_mediaPlayer.Media == null)
            {
                ...
                //_mediaPlayer.Media = new Media(_libVLC, new Uri("https://cph-p2p-msl.akamaized.net/hls/live/2000341/test/master.m3u8"));
                _mediaPlayer.Media = new Media(_libVLC, new Uri("rtsp://rtsp.stream/pattern"));
            }
    ...
    void Update()
    {
        ...
        if (tex == null)
        {
            ...
            uint i_videoHeight = 240;
            uint i_videoWidth = 360;
